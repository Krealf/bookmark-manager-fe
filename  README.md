...
Для полноценного запуска вместе с MongoDB и фронтендом используйте главный
репозиторий [bookmark-manager-infra](https://github.com/krealf/bookmark-manager-infra).
